                        ...
                        if activity_ids:
                            ...
                            for activity in activity_ids:
                                ...
                                if alarm.sh_reminder_unit == 'Hour(s)' and activity.sh_date_deadline:
                                    deadline_date_hours_added = activity.sh_date_deadline.astimezone(user_tz).replace(tzinfo=None)
                                    ...
                                    deadline_date_minutes_added = activity.sh_date_deadline.astimezone(user_tz).replace(tzinfo=None)
                                    ...
                                    deadline_date_seconds_added = activity.sh_date_deadline.astimezone(user_tz).replace(tzinfo=None)
                                    deadline_date = deadline_date_seconds_added - \
                                        timedelta(
                                            seconds=alarm.sh_remind_before)
                                if deadline_date and deadline_date != False:
                                    if alarm.type == 'popup':
                                        now = fields.Datetime.now().astimezone(user_tz).replace(tzinfo=None)
